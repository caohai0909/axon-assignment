...
public class BuiltInAction {
    ...
    /**
     * Retrieves inner text from the specified element.
     *
     * @param locator Located by CSS|XPath|ILocator.
     */
    public static String getInnerText(By locator) {
        try {
            return Objects.requireNonNull(getWebElement(locator)).getAttribute("innerHTML");
        } catch (Exception err) {
            System.out.println("Error Get Element Inner Text : --- " + err);
            return null;
        }
    }
    /**
    ...
    public static void writteDataAtOne(String filePath, List<String[]> data){
